...
{
    std::cout << "-----------------------------------------------------------------" << std::endl;
    std::cout << "|        Platin Developmentstudios Archive Format (PDA)         |" << std::endl;
    std::cout << "|      Copyright (C) 2020 - 2022 Platin Developmentstudios      |" << std::endl;
    std::cout << "-----------------------------------------------------------------" << std::endl;
    std::cout << "| Usage:                                                        |" << std::endl;
    std::cout << "|  list -- List files in image                                  |" << std::endl;
    std::cout << "|    Example: pda list myimage.pda                              |" << std::endl;
    std::cout << "|  create -- Create image from files                            |" << std::endl;
    std::cout << "|    Example: pda create myimage.pda file.txt file2.txt mydir   |" << std::endl;
    std::cout << "|  extract -- List files in image                               |" << std::endl;
    std::cout << "|    Example: pda extract myimage.pda outdir                    |" << std::endl;
    std::cout << "-----------------------------------------------------------------" << std::endl;
}
